...
<html lang="en">
  <head>
    ...
    <!-- Website Title -->
    <title>Aturan | Sistem Pakar Forward Chaining</title>
    <!-- Favicon Website -->
      ...
      <div class="sidebar bg-white">
        <div class="container p-3">
          ...
          <div class="mb-3">
            ...
            <a href="../aturan/aturan.php" class="active"><span class="iconify icon me-2" data-icon="codicon:law" data-width="45"></span>Aturan</a>
