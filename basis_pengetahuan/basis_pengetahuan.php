...
<html lang="en">
  <head>
    ...
    <!-- Website Title -->
    <title>Basis Pengetahuan | Sistem Pakar Forward Chaining</title>
    <!-- Favicon Website -->
      ...
      <div class="sidebar bg-white">
        <div class="container p-3">
          ...
          <div class="mb-3">
            ...
            <a href="../basis_pengetahuan/basis_pengetahuan.php" class="active"><span class="iconify icon me-2" data-icon="simple-icons:knowledgebase" data-width="45"></span>Basis Pengetahuan</a>
      ...
      <main>
        <div class="container ps-4 pe-4 pt-2 pb-2">
          ...
          <nav class="navbar navbar-light">
            ...
            <div class="navbar-text fw-bold fs-5">Basis Pengetahuan</div>
