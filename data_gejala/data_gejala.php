...
<html lang="en">
  <head>
    ...
    <!-- Website Title -->
    <title>Data Gejala | Sistem Pakar Forward Chaining</title>
    <!-- Favicon Website -->
      ...
      <div class="sidebar bg-white">
        <div class="container p-3">
          ...
          <div class="mb-3">
            ...
            <a href="../data_gejala/data_gejala.php" class="active"><span class="iconify icon me-2" data-icon="medical-icon:i-infectious-diseases" data-width="45"></span>Data Gejala</a>
